...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_I_GETC = 3,                     /* I_GETC  */
  YYSYMBOL_I_GETN = 4,                     /* I_GETN  */
  YYSYMBOL_I_PUTC = 5,                     /* I_PUTC  */
  YYSYMBOL_I_PUTN = 6,                     /* I_PUTN  */
  YYSYMBOL_I_PSH = 7,                      /* I_PSH  */
  YYSYMBOL_I_DUP = 8,                      /* I_DUP  */
  YYSYMBOL_I_XCHG = 9,                     /* I_XCHG  */
  YYSYMBOL_I_DROP = 10,                    /* I_DROP  */
  YYSYMBOL_I_ADD = 11,                     /* I_ADD  */
  YYSYMBOL_I_SUB = 12,                     /* I_SUB  */
  YYSYMBOL_I_MUL = 13,                     /* I_MUL  */
  YYSYMBOL_I_DIV = 14,                     /* I_DIV  */
...
#line 83 "asm.y"
    ...
    switch((yyvsp[0].string)[strlen((yyvsp[0].string)) - 1]) {
        case 'h': case 'H': base = 16; break;
        case 'b': case 'B': base =  2; break;
    }

    ret = strtol((yyvsp[0].string), NULL, base);
